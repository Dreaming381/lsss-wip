    ...
    public static class TransformsBootstrap
    {
        public static void InstallLatiosTransformsBakers(ref CustomBakingBootstrapContext context)
        {
            ...
            foreach (var system in systems)
            {
                ...
                {
                    context.systemTypesToDisable.Add(system);
                    break;
                }
                context.systemTypesToInject.Add(typeof(Latios.Transforms.Authoring.Systems.TransformBakingSystem));
            }
        }
    }
}
...
namespace Latios.Transforms.Authoring.Systems
{
    ...
    public partial struct TransformBakingSystem : ISystem
    {
        ...
        struct Job : IJobChunk
        {
            ...
            public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
            {
                ...
                for (int i = 0; i < chunk.Count; i++)
                {
                    ...
                    if (needsWorldTransform == true && needsLocalTransform == false)
                    {
                        ...
                        GetScaleAndStretch(transformAuthoring.LocalScale, out var scale, out var stretch);
            ...
            void GetScaleAndStretch(float3 localScale, out float scale, out float3 stretch)
            {
