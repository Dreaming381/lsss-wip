...
namespace Latios.Transforms
{
    ...
    public partial struct ParentChangeSystem : ISystem
    {
        ...
        EntityQuery m_newChildrenNotIdentityQuery;
        EntityQuery m_deadChildrenQuery;
        EntityQuery m_allChildrenQuery;
        EntityQuery m_deadParentsQuery;
        EntityQuery m_identityCorrectionQuery;
        EntityQuery m_parentlessCorrectionQuery;

        public void OnCreate(ref SystemState state)
        {
            m_newChildrenIdentityQuery    = QueryBuilder().WithAll<Parent, IdentityLocalToParentTransformTag>().WithNone<PreviousParent>().Build();
            m_newChildrenNotIdentityQuery = QueryBuilder().WithAll<Parent>().WithNone<PreviousParent, IdentityLocalToParentTransformTag>().Build();
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            var newChildrenCount = m_newChildrenIdentityQuery.CalculateEntityCountWithoutFiltering() +
                                   m_newChildrenNotIdentityQuery.CalculateEntityCountWithoutFiltering();
