...
namespace Latios.Kinemation.Authoring.Systems
{
    ...
    [DisableAutoCreation]
    public partial class GatherBindingPathsFromShadowHierarchySystem : SystemBase
    {
        ...
        protected unsafe override void OnUpdate()
        {
            ...
            {
                m_smrCache.Clear();
                shadowRef.shadowHierarchyRoot.Value.GetComponentsInChildren(m_smrCache);
                UnityEngine.SkinnedMeshRenderer shadowSmr = null;
                var                             sourceSmr = smrRef.skinnedMeshRenderer.Value;
