    ...
    public partial struct AllocateLinearBlendMatricesSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            state.Dependency = new ChunkPrefixSumJob
            {
                ...
                maxRequiredLinearBlendMatricesCdfe = state.GetComponentLookup<MaxRequiredLinearBlendMatrices>(),
        ...
        struct ChunkPrefixSumJob : IJobEntityBatch
        {
            ...
            public ComponentLookup<MaxRequiredLinearBlendMatrices>     maxRequiredLinearBlendMatricesCdfe;
