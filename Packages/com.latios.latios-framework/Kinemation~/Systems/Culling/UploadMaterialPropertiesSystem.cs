...
namespace Latios.Kinemation.Systems
{
    ...
    public partial class UploadMaterialPropertiesSystem : SubSystem
    {
        ...
        protected override unsafe void OnUpdate()
        {
            ...
            ComponentTypeCacheBurstHelpers.FetchTypeHandlesBursted(ref context.componentTypeCache, SystemHandle, ref worldUnmanaged, out var typeIndicesTemp);
    ...
    {
        public static unsafe void FetchTypeHandlesBursted(ref ComponentTypeCache cache, in SystemHandle handle, ref WorldUnmanaged world, out NativeArray<int> typeIndices)
        {
