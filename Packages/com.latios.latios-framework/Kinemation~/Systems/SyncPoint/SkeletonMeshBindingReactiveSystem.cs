...
namespace Latios.Kinemation.Systems
{
    ...
    public partial class SkeletonMeshBindingReactiveSystem : SubSystem
    {
        ...
        protected override void OnUpdate()
        {
            ...
            if (requiresStructuralChange)
            {
                ...
                if (!EntityManager.Exists(m_failedBindingEntity))
                {
                    ...
                    EntityManager.AddComponents(m_failedBindingEntity, new ComponentTypeSet(typeof(LocalToWorld), typeof(FailedBindingsRootTag)));
                ...
                EntityManager.RemoveComponent(                       m_deadOptimizedSkeletonsQuery, new ComponentTypeSet(optimizedTypes));
                EntityManager.RemoveComponent(                       m_deadExposedSkeletonsQuery,
                                                                     new ComponentTypeSet(typeof(ExposedSkeletonCullingIndex), typeof(PerFrameSkeletonBufferMetadata),
                ...
                EntityManager.RemoveComponent(m_newMeshesQuery, new ComponentTypeSet(transformComponentsThatWriteToLocalToParent));
                EntityManager.AddComponent(m_newMeshesQuery, new ComponentTypeSet(typeof(SkeletonDependent), typeof(LocalToParent), typeof(Parent)));

                optimizedTypes.Add(typeof(DependentSkinnedMesh));

                EntityManager.AddComponent(m_newOptimizedSkeletonsQuery, new ComponentTypeSet(optimizedTypes));
                EntityManager.AddComponent(m_newExposedSkeletonsQuery,
                                           new ComponentTypeSet(typeof(DependentSkinnedMesh), typeof(PerFrameSkeletonBufferMetadata),
        ...
        struct FindDeadSkeletonsJob : IJobEntityBatch
        {
            ...
            [NativeDisableParallelForRestriction] public ComponentLookup<SkeletonDependent> meshStateCdfe;
        ...
        struct FindNewMeshesJob : IJobEntityBatch
        {
            ...
            [ReadOnly] public ComponentLookup<SkeletonRootTag>                   skeletonRootTagCdfe;
            [ReadOnly] public ComponentLookup<BindSkeletonRoot>                  bindSkeletonRootCdfe;
            [ReadOnly] public ComponentLookup<BoneOwningSkeletonReference>       boneOwningSkeletonReferenceCdfe;
            [ReadOnly] public ComponentLookup<SkeletonBindingPathsBlobReference> skeletonBindingPathsBlobRefCdfe;
        ...
        {
            [NativeDisableParallelForRestriction] public ComponentLookup<SkeletonDependent> stateCdfe;
            [NativeDisableParallelForRestriction] public ComponentLookup<Parent>            parentCdfe;
        ...
        struct ProcessBindingOpsJob : IJobParallelForDefer
        {
            ...
            [ReadOnly] public ComponentLookup<SkeletonDependent> meshStateCdfe;
            [ReadOnly] public BufferLookup<OptimizedBoneToRoot>      boneToRootsBfe;
            [ReadOnly] public BufferLookup<BoneReference>            boneRefsBfe;
            [ReadOnly] public MeshGpuManager                             meshGpuManager;
            [ReadOnly] public BoneOffsetsGpuManager                      boneOffsetsGpuManager;

            [NativeDisableParallelForRestriction] public BufferLookup<DependentSkinnedMesh>              dependentsBfe;
            [NativeDisableParallelForRestriction] public BufferLookup<OptimizedBoneBounds>               optimizedBoundsBfe;
            [NativeDisableParallelForRestriction] public ComponentLookup<BoneBounds>                 boneBoundsCdfe;
            [NativeDisableParallelForRestriction] public ComponentLookup<SkeletonShaderBoundsOffset> optimizedShaderBoundsCdfe;
        ...
        struct SetExposedSkeletonCullingIndicesJob : IJobParallelForDefer
        {
            ...
            [ReadOnly] public BufferLookup<BoneReference>                                                 boneRefsBfe;
            [NativeDisableParallelForRestriction] public ComponentLookup<ExposedSkeletonCullingIndex> skeletonCullingIndexCdfe;
            [NativeDisableParallelForRestriction] public ComponentLookup<BoneCullingIndex>            boneCullingIndexCdfe;
            [NativeDisableParallelForRestriction] public ComponentLookup<BoneIndex>                   boneIndexCdfe;
            [NativeDisableParallelForRestriction] public ComponentLookup<BoneOwningSkeletonReference> skeletonReferenceCdfe;
