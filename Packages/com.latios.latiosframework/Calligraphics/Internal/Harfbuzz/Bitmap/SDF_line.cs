...
namespace Latios.Calligraphics.HarfBuzz.Bitmap
{
    internal static class SDF_line
    {
        ...
        /// </summary>
        public static bool SDFGenerateSubDivisionLineEdges(SDFOrientation orientation,
        ...
        public static bool SDFGenerateSubDivisionLineEdges_Overlap(SDFOrientation orientation,
                                                                   ref DrawData drawData,
                                                                   ref NativeArray<byte> buffer,
                                                                   ref GlyphRect atlasRect,
                                                                   int padding,
