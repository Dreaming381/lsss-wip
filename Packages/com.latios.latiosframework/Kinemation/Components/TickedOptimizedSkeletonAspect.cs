...
namespace Latios.Kinemation
{
    ...
    {
        TickedOptimizedSkeletonWorldTransform m_worldTransform;

        RefRO<OptimizedSkeletonHierarchyBlobReference>       m_skeletonHierarchyBlobRef;
        RefRW<TickedOptimizedSkeletonState>                  m_skeletonState;
        DynamicBuffer<TickedOptimizedBoneTransform>          m_boneTransforms;
        DynamicBuffer<TickedOptimizedBoneInertialBlendState> m_bonesInertialBlendStates;

        short m_boneCount;
        short m_socketCount;  // Only used for QVVS

        #region Constructors
        public TickedOptimizedSkeletonAspect(
            TickedTransformAspect transformAspect,
            ...
            RefRW<TickedOptimizedSkeletonState>                      optimizedSkeletonState,
            ref DynamicBuffer<TickedOptimizedBoneTransform>          optimizedBoneTransformBuffer,
            ref DynamicBuffer<TickedOptimizedBoneInertialBlendState> optimizedBoneInertialBlendStateBuffer,
            DynamicBuffer<DependentSkinnedMesh>                      optionalDependentSkinnedMeshesBufferRO
            )
        {
            this                       = default;
            m_worldTransform           = new TickedOptimizedSkeletonWorldTransform(transformAspect);
        ...
        /// </summary>
        public TickedOptimizedBoneInSkeletonArray bones => new TickedOptimizedBoneInSkeletonArray
        {
        ...
        /// call this method to make transforms valid and accessible via TickedOptimizedBone handles.
    ...
    /// <summary>
    /// An Optimized Bone handle that can be acquired from an TickedOptimizedSkeletonAspect.
    ...
    public partial struct TickedOptimizedBone
    {
        ...
        /// The parent bone,
        /// </summary>
        public TickedOptimizedBone parent
        {
            get
            {
        ...
        /// <summary>
        /// Access to the array of TickedOptimizedBones which are immediate children of this bone
        /// </summary>
        public TickedOptimizedBoneChildrenArray children => new TickedOptimizedBoneChildrenArray
        {
    ...
    /// </summary>
    public struct TickedOptimizedBoneChildrenArray
    {
        ...
        public TickedOptimizedBone this[int childIndex]
        {
            get
            {
                return new TickedOptimizedBone
                {
                    m_skeletonWorldTransform   = m_skeletonWorldTransform,
                    m_skeletonHierarchyBlobRef = m_skeletonHierarchyBlobRef,
                    m_skeletonState            = m_skeletonState,
    ...
    /// </summary>
    public struct TickedOptimizedBoneInSkeletonArray
    {
        internal TickedOptimizedSkeletonWorldTransform          m_skeletonWorldTransform;
        internal RefRO<OptimizedSkeletonHierarchyBlobReference> m_skeletonHierarchyBlobRef;
        internal RefRW<TickedOptimizedSkeletonState>            m_skeletonState;
        ...
        /// </summary>
        public TickedOptimizedBone this[int boneIndex]
        {
            get
            {
                return new TickedOptimizedBone
