...
namespace Latios.Myri
{
    ...
    [BurstCompile]
    public partial struct AudioSystem2 : ISystem, ISystemShouldUpdate
    {
        ...
        public unsafe void OnUpdate(ref SystemState state)
        {
            ...
            var changedListenersJh = new InitUpdateDestroy2.UpdateChangedListenersJob
            {
            ...
            var captureListenersJh = new InitUpdateDestroy2.CaptureListenersForSamplingJob
            {
            ...
            var captureFrameJh = new InitUpdateDestroy2.CaptureIldFrameJob
            {
            ...
            var updateSourcesJh = new InitUpdateDestroy2.UpdateClipAudioSourcesJob
            {
                capturedFrameState         = m_capturedFrameState,
            ...
            if (sourcesChunkCount > 0 && listenerCount > 0)
            {
                ...
                var samplingJh = new Sampling2.SampleJob
                {
                    capturedSources         = capturedSourcesStream.AsReader(),
