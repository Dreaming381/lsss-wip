...
namespace Latios.Transforms
{
    internal static class TreeChangeInstantiate
    {
        public static void AddChildren(ref IInstantiateCommand.Context context)
        {
            ...
            var childAddSets = new NativeArray<ChildAddSet>(entities.Length, Allocator.TempJob, NativeArrayOptions.UninitializedMemory);
            var classifyJh   = new ClassifyJob
            {
                children              = childWorkStates,
                childAddSets          = childAddSets,
            ...
            var sortChildAddJh = new SortAddChildrenJob
            {
                childAddSets = childAddSets
            }.Schedule(classifyJh);
        ...
        struct ChildAddSet : IComparable<ChildAddSet>
        {
            public TreeKernels.ComponentAddSet addSet;
            public int                         chunkOrder;
            public int                         indexInChunk;

            public int CompareTo(ChildAddSet other)
            {
