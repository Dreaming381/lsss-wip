...
namespace Latios.Transforms
{
    ...
    /// </summary>
    public unsafe struct TransformDeferableAspect
    {
        internal TransformAspect                        transform;
        internal NativeList<TransformBatchWriteCommand> commands;
        ...
        public float3 worldPosition
        {
            ...
            set
            {
                if (transform.entityInHierarchyHandle.isNull)
                    ...
                    commands.Add(TransformBatchWriteCommand.SetWorldPosition(transform, value));
            }
        }
        ...
        public quaternion worldRotation
        {
            ...
            set
            {
                if (transform.entityInHierarchyHandle.isNull)
                    ...
                    commands.Add(TransformBatchWriteCommand.SetWorldRotation(transform, value));
            }
        }
        ...
        public float worldScale
        {
            ...
            set
            {
                if (transform.entityInHierarchyHandle.isNull)
                    ...
                    commands.Add(TransformBatchWriteCommand.SetWorldScale(transform, value));
            }
        }
        ...
        public float3 localPosition
        {
            ...
            set
            {
                if (transform.entityInHierarchyHandle.isNull)
                    ...
                    commands.Add(TransformBatchWriteCommand.SetLocalPosition(transform, value));
            }
        }
        ...
        public quaternion localRotation
        {
            ...
            set
            {
                if (transform.entityInHierarchyHandle.isNull)
                    ...
                    commands.Add(TransformBatchWriteCommand.SetLocalRotation(transform, value));
            }
        }
        ...
        public float localScale
        {
            ...
            set
            {
                if (transform.entityInHierarchyHandle.isNull)
                    ...
                    commands.Add(TransformBatchWriteCommand.SetLocalScale(transform, value));
            }
        }
        ...
        public float3 stretch
        {
            ...
            set
            {
                if (transform.entityInHierarchyHandle.isNull)
                    ...
                    commands.Add(TransformBatchWriteCommand.SetStretch(transform, value));
            }
        }
        ...
        public TransformQvvs worldTransform
        {
            ...
            set
            {
                if (transform.entityInHierarchyHandle.isNull)
                    ...
                    commands.Add(TransformBatchWriteCommand.SetWorldTransform(transform, in value));
            }
        }
        ...
        public TransformQvs localTransform
        {
            ...
            set
            {
                if (transform.entityInHierarchyHandle.isNull)
                    ...
                    commands.Add(TransformBatchWriteCommand.SetLocalTransform(transform, in value));
            }
        }
        ...
        public TransformQvvs localTransformQvvs
        {
            ...
            set
            {
                if (transform.entityInHierarchyHandle.isNull)
                    ...
                    commands.Add(TransformBatchWriteCommand.SetLocalTransformQvvs(transform, in value));
            }
        }
        #endregion
        ...
        /// <summary>
        /// Retrieves the EntityInHierarchyHandle of this TransformDeferableAspect. Note that if the entity
        ...
        /// <summary>
        /// Retrieves the read-only form of this TransformDeferableAspect. The read-only form can be used in
        /// methods that require it, or to read other transforms in the hierarchy without dirtying
        /// change filters.
        /// </summary>
        public TransformReadAspect asRO => transform.asRO;

        /// <summary>
        /// Retrieves the TransformDeferableAspect for the specified handle belonging to the same hierarchy
        /// as this TransformDeferableAspect. When safety checks exist, this method throws if the specifed
        /// handle comes from another hierarchy or if either its handle or this TransformDeferableAspect's
        /// handle is null.
        /// </summary>
        public TransformDeferableAspect this[EntityInHierarchyHandle otherHandle]
        {
            get => new TransformDeferableAspect
            {
        ...
        /// <summary>
        /// Attempts to retrieve the TransformDeferableAspect for the specified handle belonging to the same
        /// hierarchy as this TransformDeferableAspect. When safety checks exist, this method throws if the
        /// specifed handle comes from another hierarchy. This method returns false if the transform
        /// is not present.
        /// </summary>
        public bool TryGetAspect(in EntityInHierarchyHandle otherHandle, out TransformDeferableAspect otherTransformDeferableAspect)
        {
            var result                    = transform.TryGetAspect(in otherHandle, out var otherTransform);
            otherTransformDeferableAspect = new TransformDeferableAspect
            {
        ...
        public void TranslateLocal(float3 translation)
        {
            if (transform.entityInHierarchyHandle.isNull)
                ...
                commands.Add(TransformBatchWriteCommand.TranslateLocal(transform, translation));
        }
        /// <summary>
        ...
        public void RotateLocal(quaternion rotation)
        {
            if (transform.entityInHierarchyHandle.isNull)
                ...
                commands.Add(TransformBatchWriteCommand.RotateLocal(transform, rotation));
        }
        ...
        public void SetWorldPositionAndRotation(float3 worldPosition, quaternion worldRotation)
        {
            if (transform.entityInHierarchyHandle.isNull)
                ...
                commands.Add(TransformBatchWriteCommand.SetWorldPositionAndRotation(transform, worldPosition, worldRotation));
        }
        ...
        public void SetLocalPositionAndRotation(float3 localPosition, quaternion localRotation)
        {
            if (transform.entityInHierarchyHandle.isNull)
                ...
                commands.Add(TransformBatchWriteCommand.SetLocalPositionAndRotation(transform, localPosition, localRotation));
        }
        ...
        public void TranslateRotateWorld(float3 translation, quaternion rotation)
        {
            if (transform.entityInHierarchyHandle.isNull)
                ...
                commands.Add(TransformBatchWriteCommand.TranslateRotateWorld(transform, translation, rotation));
        }
        ...
        public void TranslateRotateLocal(float3 translation, quaternion rotation)
        {
            if (transform.entityInHierarchyHandle.isNull)
                ...
                commands.Add(TransformBatchWriteCommand.TranslateRotateLocal(transform, translation, rotation));
        }
        ...
        public float3 TransformPointLocalToWorld(float3 point) => transform.TransformPointLocalToWorld(point);

        /// <summary>Transform a point from world space into local space.</summary>
        /// <param name="point">The point to transform</param>
        /// <returns>The transformed point</returns>>
        public float3 TransformPointWorldToLocal(float3 point) => transform.TransformPointWorldToLocal(point);
        ...
        public float3 TransformDirectionLocalToWorld(float3 direction) => transform.TransformDirectionLocalToWorld(direction);
        ...
        /// <param name="direction">The direction to transform</param>
        /// <returns>The transformed direction</returns>>
        public float3 TransformDirectionLocalToWorldWithStretch(float3 direction) => transform.TransformDirectionLocalToWorldWithStretch(direction);
        ...
        /// <param name="direction">The direction to transform</param>
        /// <returns>The transformed direction</returns>>
        public float3 TransformDirectionLocalToWorldScaledAndStretched(float3 direction) => transform.TransformDirectionLocalToWorldScaledAndStretched(direction);

        /// <summary>Transforms a direction vector from world space into local space, ignoring the effects of stretch.</summary>
        /// <param name="direction">The direction to transform</param>
        /// <returns>The transformed direction</returns>>
        public float3 TransformDirectionWorldToLocal(float3 direction) => transform.TransformDirectionWorldToLocal(direction);
        ...
        /// <param name="direction">The direction to transform</param>
        /// <returns>The transformed direction</returns>>
        public float3 TransformDirectionWorldToLocalWithStretch(float3 direction) => transform.TransformDirectionWorldToLocalWithStretch(direction);
        ...
        /// <param name="direction">The direction to transform</param>
        /// <returns>The transformed direction</returns>>
        public float3 TransformDirectionWorldToLocalScaledAndStretched(float3 direction) => transform.TransformDirectionWorldToLocalScaledAndStretched(direction);
        #endregion
    }
}
#endif
